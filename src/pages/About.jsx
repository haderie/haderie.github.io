      ...
      <section className="aboutDescription">
        <div className="secondHalf" >
          ...
          <div className="content-wrapper">
            ...
            I thrive on transforming ideas into tangible solutions through code. Throughout my academic and personal projects, I strive to create 
            solutions that not only showcase technical prowess but also resonate with the needs of the community. My belief in the importance of 
            collaboration extends beyond the digital realm, and I actively seek opportunities to engage with and contribute to the communities around me.
